...
This is further qualified by [ADR-0005](0005-preset-sync.md) and [ADR-0006](0006-history-sync.md): user-created presets and completed session history now also sync to Supabase while logged in, though `localStorage` remains the source of truth when logged out.
