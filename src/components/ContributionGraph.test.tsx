...
import { GRID_ROWS, GRID_WEEKS } from '../derived/contributionGraph'
...
describe('ContributionGraph', () => {
  it('renders a fixed 53x7 grid of cells regardless of history', () => {
    const { container } = render(<ContributionGraph history={[]} now={new Date('2026-07-14T12:00:00')} />)
  ...
  it('renders empty days at the lowest intensity level', () => {
    render(<ContributionGraph history={[]} now={new Date('2026-07-14T12:00:00')} />)
  ...
  it('gives a day with sessions a higher intensity level than an empty day', () => {
    ...
    render(<ContributionGraph history={history} now={new Date('2026-07-14T12:00:00')} />)
